...
export class SidebarComponent implements OnInit {
  ...
  get filterConversations() {
    return this.conversations.filter((ele) => {
      return (
        ele.name.toLowerCase().includes(this.searchValue.toLowerCase()) ||
        ele.latestMessage.toLowerCase().includes(this.searchValue.toLowerCase())
      );
    });
  }
